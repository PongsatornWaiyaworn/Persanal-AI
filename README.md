...
1. **ภาพรวมของ Object Detection**
   ...
   **คำจำกัดความ:**
   ...
   วัตถุประสงค์หลัก:
   1. **Localization**: หาตำแหน่งวัตถุในภาพโดยใช้กรอบสี่เหลี่ยม (Bounding Box)
   2. **Classification**: ระบุว่าวัตถุนั้นคืออะไร
